		...
		<dl id="comment-box-<?php echo $post->ID;?>" class="comment-box mod <?php echo $com_hide_class;?>">
			<dt class="comment-box-title mod-title">
				...
				<?php if(comments_open()){ ?>
					<a href="javascript:void(0)" class="add-comment add-comment-top add-comment-<?php echo $post->ID;?>" data-post-id="<?php echo $post->ID;?>"><span class="icon-bubbles"></span><span class="after-icon"><?php echo ___('Join the comments');?></span></a>
				<?php } ?>
			...
			<dd class="mod-body">
				 ...
				 */
				if(comments_open()){ ?>
					<a href="javascript:void(0)" class="add-comment add-comment-bottom btn add-comment-<?php echo $post->ID;?>" data-post-id="<?php echo $post->ID;?>"><span class="icon-bubbles"></span><span class="after-icon"><?php echo ___('Join the comments');?></span></a>
				<?php } ?>
			</dd>
		</dl>
		<?php
