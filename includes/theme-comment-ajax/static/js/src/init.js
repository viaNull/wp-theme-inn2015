			...
			brefore_send : function(){
				...
				if(is_json){
					if(data && data.status && data.status === 'success'){
						...
						exports.cache.$comm_respond.find('#comment').val('');
						exports.hook.tip('success',data.des.content,exports.config.lang.M00003,3000);
					}else if(data && data.status && data.status === 'error'){
						exports.hook.tip('error',data.des.content,exports.config.lang.M00003);
					}else{
