...
add_action('admin_init','theme_options::init',99);
class theme_options{
	...
	public static function display(){
		...
		<div class="wrap">
			<h2><?php echo wp_get_theme();?> <?php echo esc_html(___('theme settings'));?></h2>
	...
	public static function delete_options($key = null){
		...
		$options = self::get_options();
		unset($options[$key]);
		delete_option(self::$iden,$options);
	}
	/**
	 * is_options_page
	 * 
